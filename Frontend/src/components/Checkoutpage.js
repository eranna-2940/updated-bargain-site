...
const Checkout = () => {
  ...
  const [fields, setFields] = useState({
    ...
    pincode: "",
    phone: user.phone,
    buyer_id:sessionStorage.getItem('user-token')
  });
  ...
  //   try {
  //     // Define variables to hold shipping and billing address data
  //     let shippingAddressData = {};
  //     let billingAddressData = {};
  
  //     // Check if the user selected to use the same address for shipping and billing
  //     if (selectedOption === "same") {
  //       // Use the same data for both shipping and billing addresses
  //       shippingAddressData = fields;
  //       billingAddressData = fields;
  //     } else {
  //       // If the user selected to use a new address or didn't select an option (default),
  //       // use the appropriate data based on the selection
  //       if (selectedOption === "new") {
  //         // Use newFields for shipping address if "new" is selected
  //         shippingAddressData = newFields;
  //       } else {
  //         // Use fields for shipping address by default
  //         shippingAddressData = fields;
  //       }
  
  //       // Always use newFields for billing address

...
const Addproducts = () => {
  ...
  // Can it be altered: No
  // Size: XS
  // Size (Measurements): 32-34
  // Times Worn: 1
  ...
  // Original Price: ₹599
  // Purchase Date: January 12, 2024
  // Seller: ABC Fashion Store
  // Condition: Like new
  // Additional Notes: Received as a gift but doesn't fit properly, hence only worn once.

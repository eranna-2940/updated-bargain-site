...
app.post("/addproducts", (req, res) => {
  const sql =
    "INSERT INTO products (`product_type`,`category`,`name`,`description`,`image`,`location`,`color`,`alteration`,`size`,`measurements`,`worn`,`price`,`accepted_by_admin`,`seller_id`,`payment_status`,`buyer_id`) VALUES (?)";
  const values = [
...
app.post("/register", (req, res) => {
  const sql = "INSERT INTO register (`firstname`,`lastname`,`email`,`password`,`phone` ) VALUES (?)";
  const values = [
    req.body.firstname,
    req.body.lastname,
    req.body.email,
